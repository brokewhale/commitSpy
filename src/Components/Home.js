                                ...
                                <div className="home_grid">
                                    ...
                                    <Switch>
                                        ...
                                        <Route path='/home/user' >
                                            <div className="showmain">
                                                <User token={token} name={me.user.username} twitter={me.user.twitter} img={me?.user.avatar} email={me.user.email} projects={projects.length} wallet={me.user.wallet} proj={projects} />
